  ...
  return (
    ...
    >
      ...
      {project.thumbnail ? (
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#2d2a25] to-[#1d1a15] flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-[#D0BB95]/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
